...
[![My Skills](https://skillicons.dev/icons?i=java,typescript,javascript,python,c,cpp,cs,html,css,tailwind,mui,express,dotnet,spring,postman,jest,supabase,nodejs,react,nextjs,angular,git,githubactions,docker,aws,linux,postgres,redis,mysql,mongodb&theme=light)](https://skillicons.dev)
